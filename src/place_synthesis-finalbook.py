...
with Database(config) as db:
    ...
    for placerow in place_results:
        place = Place(
            ...
            name_invented=INVENTED_STATUS.get(truthy(placerow[2])),
...
place_csv = r"C:\Users\lroyte\Documents\Bucket_Connect_Welikia\book\a Welikia Atlas\3 - gazetteer\plate_grid\placename_v7.4_grid_10072024.csv"
...
with outputfile.open("w", encoding='utf-8') as f:
    for place in places:
        ...
        entry = f"""
**{place.output_name}{place.name_invented}{place.status}**{'^' *whitespace}{f'Plate {place.plate} ({place.grid})'}
